export default {
  forms: {
    orzeczenia: [{name: 'ABA', title: 'ABA'}, {name: 'orzeczenie_kierowcy', title: 'Orzeczenie kierowcy'},
      ...
      {name: 'orzeczenie_uczniow', title: 'Orzeczenie lekarskie uczniów i studentów'},
    ...
    zaswiadczenia: [{name: 'zaswiadczenie', title: 'Zaświadczenie'}, {
      name: 'zaswiadczenie_okulary',
      title: 'Zaświadczenie okulary'
    }],
    skierowania: [
      {name: 'skierowanie_do_szpitala', title: 'Skierowanie do szpitala'},
      {name: 'skierowanie_rtg', title: 'Skierowanie RTG'},
      {name: 'skierowanie_na_badania', title: 'Skierowanie na badania'}
    ],
    karty: [{name: 'karta_badania_profilaktycznego', title: 'Karta badania profilaktycznego'},
      ...
      {
        name: 'karta_konsultacyjna_diabetologiczna',
        title: 'Karta konsultacyjna diabetologiczna',
        modalClass: 'landscape-form'
      },
      {
        name: 'karta_konsultacyjna_neurologiczna',
        title: 'Karta konsultacyjna neurologiczna',
        modalClass: 'landscape-form'
      },
